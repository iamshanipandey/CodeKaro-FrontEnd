...
function DeleteAccountModal({modalData}){
    return(
        <div className="w-full z-10 absolute flex justify-center items-center h-full backdrop-blur-md bg-transparent">
            <div className="sm:w-[350px] lg:w-[400px] md:w-[400px] border-2 rounded-xl py-8 border-richblack-700 bg-richblack-900 p-5 items-center flex flex-col">
                ...
                <p className="text-richblack-100 mt-2">{modalData.text2}</p>
